...
public interface FederationMembershipStateStore {
   ...
   */
  SubClusterRegisterResponse registerSubCluster(SubClusterRegisterRequest registerSubClusterRequest) throws YarnException;
   ...
   * @throws YarnException if the request is invalid/fails
   */
  SubClusterDeregisterResponse deregisterSubCluster(SubClusterDeregisterRequest subClusterDeregisterRequest)
   ...
   * @throws YarnException if the request is invalid/fails
   */
  SubClusterHeartbeatResponse subClusterHeartbeat(SubClusterHeartbeatRequest subClusterHeartbeatRequest)
      throws YarnException;
   ...
   * @throws YarnException if the request is invalid/fails
   */
  GetSubClusterInfoResponse getSubCluster(GetSubClusterInfoRequest subClusterRequest) throws YarnException;
   ...
   * @throws YarnException if the request is invalid/fails
   */
  GetSubClustersInfoResponse getSubClusters(GetSubClustersInfoRequest subClustersRequest) throws YarnException;
