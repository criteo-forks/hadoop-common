...
public class DatanodeInfo extends DatanodeID implements Node {
  ...
  public DatanodeInfo(DatanodeID nodeID, String location,
      ...
      final long lastUpdate, final long lastUpdateMonotonic, final int xceiverCount,
    ...
    this(nodeID.getIpAddr(), nodeID.getHostName(), nodeID.getDatanodeUuid(),
        ...
        cacheCapacity, cacheUsed, lastUpdate, lastUpdateMonotonic, xceiverCount, location,
  ...
  public DatanodeInfo(final String ipAddr, final String hostName,
      ...
      final long capacity, final long dfsUsed, final long remaining,
      final long blockPoolUsed, final long cacheCapacity, final long cacheUsed,
      final long lastUpdate, final long lastUpdateMonotonic, final int xceiverCount, final String
  ...
  public DatanodeInfo(final String ipAddr, final String hostName,
      ...
      final long cacheUsed, final long lastUpdate, final long lastUpdateMonotonic, final int xceiverCount,
