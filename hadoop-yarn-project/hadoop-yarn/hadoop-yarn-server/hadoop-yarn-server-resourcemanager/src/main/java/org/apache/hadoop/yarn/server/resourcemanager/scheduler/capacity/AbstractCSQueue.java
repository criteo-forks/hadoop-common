...
public abstract class AbstractCSQueue implements CSQueue {
  ...
  protected void setupConfigurableCapacities() {
    CSQueueUtils.loadUpdateAndCheckCapacities(
        getQueuePath(),
        accessibleLabels, 
        (CapacitySchedulerConfiguration) csContext.getSchedulerConfiguration(),
        queueCapacities,
  ...
  synchronized void setupQueueConfigs(Resource clusterResource)
    ...
    this.accessibleLabels =
        ((CapacitySchedulerConfiguration) csContext.getSchedulerConfiguration()).getAccessibleNodeLabels(getQueuePath());
    this.defaultLabelExpression = ((CapacitySchedulerConfiguration) csContext.getSchedulerConfiguration())
    ...
    this.state = ((CapacitySchedulerConfiguration) csContext.getSchedulerConfiguration()).getState(getQueuePath());
    this.acls = ((CapacitySchedulerConfiguration) csContext.getSchedulerConfiguration()).getAcls(getQueuePath());
    ...
    this.reservationsContinueLooking = ((CapacitySchedulerConfiguration) csContext.getSchedulerConfiguration())
