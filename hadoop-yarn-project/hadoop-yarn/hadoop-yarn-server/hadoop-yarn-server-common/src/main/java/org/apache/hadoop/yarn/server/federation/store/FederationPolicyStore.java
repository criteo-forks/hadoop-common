...
public interface FederationPolicyStore {
   ...
   */
  GetSubClusterPolicyConfigurationResponse getPolicyConfiguration(GetSubClusterPolicyConfigurationRequest request) throws YarnException;
   ...
   * @throws YarnException if the request is invalid/fails
   */
  SetSubClusterPolicyConfigurationResponse setPolicyConfiguration(SetSubClusterPolicyConfigurationRequest request) throws YarnException;
   ...
   * @throws YarnException if the request is invalid/fails
   */
  GetSubClusterPoliciesConfigurationsResponse getPoliciesConfigurations(GetSubClusterPoliciesConfigurationsRequest request) throws YarnException;
